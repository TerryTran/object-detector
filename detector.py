...
class ObjectDetector(object):
    def __init__(self, options=None, load_path=None):
        ...
        if load_path is not None:
            self._detector = dlib.simple_object_detector(load_path)
    ...
    def fit(self, image_paths, annotations, visualize=False, save_path=None):
